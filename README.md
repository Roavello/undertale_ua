...
<details>
    <summary>А чого вам зуби заговорювати? Краще один раз побачити, ніж сто разів почути!</summary>
...
І пам'ятайте: Надокучливий собака піклується про вас!<br><sub>(Очевидна брехня)</sub>
<br CLEAR="left"> 
<h3></h3>
...
\>\> <a href="https://pereclaw.nekoweb.org/postupy/summer25/">Читати довгочит</a> <<
<br>
(Для найкращого відображення сторінки радимо переглядати її з ПК або у вебверсії “для комп'ютера”)

<h4><p align="right">— DanielleTlumach<h4>
...
<ol>
    ...
    <li type="disc"><a href="https://discord.com/users/458535829753561099">perishrad</a><br>
</ol>
<h3>Озвучення</h3>
<ol>
...
<ol>
    <li type="disc">Наші улюблені тестери<br>
    ...
    <li type="disc"><a href="https://github.com/danielah05/UndertaleDecomp">Vultumast та Daniela за Undertale Decompilation</a><br>
...
В: Поки ніяк. Зараз локалізація готується до виходу, однак вже є DEMO, яке можна завантажити та пограти.
...
### Де можна буде завантажити локалізацію?
В: Там же, де й перекладене UNDERTALE DEMO -- на [KULI](https://kuli.com.ua/undertale#translations), [GitHub](https://github.com/Roavello/undertale_ua/releases) або [Nexusmods](https://www.nexusmods.com/undertale/mods/12?tab=files)
